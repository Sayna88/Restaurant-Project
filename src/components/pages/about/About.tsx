function About() {
  return (
    <div className="min-h-screen bg-black text-white px-6 py-12 md:py-20 md:px-12">
      <div className="max-w-4xl mx-auto pt-6 md:pt-12">
        <h1 className="text-4xl md:text-5xl font-bold text-yellow-500 mb-8 md:mb-10 tracking-tight text-center md:text-left">
          Our Story
        </h1>
        <div className="space-y-6 md:space-y-8 text-gray-400 text-base md:text-lg leading-relaxed border-l-2 border-yellow-500/30 pl-4 md:pl-8">
          <p>
          ...
          <p className="text-white font-medium text-lg md:text-xl italic bg-gray-900/40 p-4 md:p-6 rounded-xl border border-gray-800">
