...
const Home = () => {
  ...
  return (
    <div className="bg-black min-h-screen text-white">
      <div className="flex flex-col items-center justify-center min-h-[80vh] text-center px-4 py-12 md:p-10 md:pt-20">
        ...
        <p className="text-lg md:text-xl text-gray-400 max-w-2xl mb-12 md:mb-16">
        ...
        <div className="flex flex-wrap justify-center gap-6 md:gap-12 w-full max-w-4xl">
          {categories.map((cat, index) => (
            <div key={index} onClick={() => handleCategoryClick(cat.targetId)} className="flex flex-col items-center gap-3 md:gap-4 cursor-pointer group">
              <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full overflow-hidden border-2 border-gray-800 group-hover:border-yellow-500 transition-all duration-300 shadow-lg group-hover:shadow-[0_0_15px_rgba(234,179,8,0.4)]">
                <img src={cat.img} alt={cat.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
              </div>
              <span className="font-medium text-sm md:text-base text-gray-300 group-hover:text-yellow-500 transition-colors">{cat.name}</span>
            </div>
          ))}
        </div>
      </div>

      <section className="py-16 md:py-24 px-6 md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 border-t border-gray-800 mt-6 md:mt-10">
        <div className="w-full md:w-1/2 text-center md:text-left space-y-4 md:space-y-6">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-yellow-500">The Taste of Perfection</h2>
        ...
        <div className="w-full md:w-1/2 flex justify-center">
          ...
          <div className="w-64 h-64 sm:w-[350px] sm:h-[350px] md:w-[400px] md:h-[400px] animate-morph overflow-hidden shadow-[0_0_40px_rgba(234,179,8,0.3)] border-4 border-yellow-500/30 flex items-center justify-center bg-gray-900/50">
      ...
      <section className="py-16 md:py-24 px-6 md:px-12 bg-black border-t border-gray-800">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-10 md:mb-16 text-white max-w-xs mx-auto">
          Culinary Insights
        </h2>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          <div className="group border border-gray-800 rounded-2xl overflow-hidden hover:border-yellow-500 transition-all duration-500 bg-gray-900/30 flex flex-col">
            ...
            <div className="p-6 md:p-8 flex flex-col items-center text-center flex-1">
              <h3 className="text-xl md:text-2xl font-bold text-white mb-3 md:mb-4">The Secret of Neapolitan Pizza</h3>
              <p className="text-gray-400 text-sm md:text-base mb-6 md:mb-8 flex-1">Discover what makes our dough so airy and light, and why the perfect crust takes 72 hours of fermentation...</p>
              <Link to="/article/pizza" className="relative group/btn overflow-hidden border border-yellow-500 text-yellow-500 px-6 md:px-8 py-2 rounded-full font-bold transition-all duration-300 text-sm md:text-base">
          ...
          <div className="group border border-gray-800 rounded-2xl overflow-hidden hover:border-yellow-500 transition-all duration-500 bg-gray-900/30 flex flex-col">
            ...
            <div className="p-6 md:p-8 flex flex-col items-center text-center flex-1">
              <h3 className="text-xl md:text-2xl font-bold text-white mb-3 md:mb-4">A Journey Through Italian Pasta</h3>
              <p className="text-gray-400 text-sm md:text-base mb-6 md:mb-8 flex-1">From hand-rolled ravioli to perfectly al dente linguine, explore the rich traditions of our handmade pasta...</p>
              <Link to="/article/pasta" className="relative group/btn overflow-hidden border border-yellow-500 text-yellow-500 px-6 md:px-8 py-2 rounded-full font-bold transition-all duration-300 text-sm md:text-base">
                <span className="absolute inset-0 bg-yellow-500 -translate-y-full group-hover/btn:translate-y-0 transition-transform duration-300 ease-in-out"></span>
                <span className="relative z-10 group-hover/btn:text-black transition-colors duration-300">Read More</span>
              </Link>
            </div>
