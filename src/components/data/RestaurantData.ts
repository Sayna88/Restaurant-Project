export const restaurantMenu = [
...

  {
    ...
    description: "Pizza dough, Tomato sauce, Fresh mozzarella cheese, Fresh basil.",
    price: 11.99,
  ...
  },
  {
    ...
    description: "Baguette, Tomatoes, Fresh basil, Olive oil.",
    price: 17.99,
...

{
...

  {
    ...
    description: "Angus beef, Cheddar cheese, Lettuce, Tomato, Secret sauce.",
    price: 12.50,
